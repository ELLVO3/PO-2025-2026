...
public class zestaw2 {
    ...
    public static void main(String[] args){
        ...
        double[] genZ = generujZakres(5, 10, 20);

        double[] funkcjaLiniowa = funkcjaLiniowa(tab, 2.1, 3.3);
        double[] funkcjaKwadratowa = funkcjaKwadratowa(tab, 2, 3, 5.2);
        double[] funkcjaWykladnicza = funkcjaWykladnicza(tab, 4.5);
        double[] funkcjaSignum = funkcjaSignum_(tab);
...
//        System.out.println(Arrays.toString(funkcjaLiniowa));
//        System.out.println(Arrays.toString(funkcjaKwadratowa));
//        System.out.println(Arrays.toString(funkcjaWykladnicza));
//        System.out.println(Arrays.toString(funkcjaSignum));
//        System.out.println(najdluzszyCiagDodatnich(tab));
//        System.out.println(najdluzszyCiagUjemnychh(tab));




//        int[] odwTab = odwrocTablice2(tab, 2, 7);
...
//        }
    ...
    static int ileUnikalnych(int tab[]){
        int unique = 0;
        for(int i = 0; i < tab.length; i++){
    ...
    // Zadanie 19.
    // Napisz funkcje funkcjaWykladnicza(tab, a) zwracające tablice wartości funkcji.
    ...
    static double[] funkcjaSignum_(int[] tab){
        double[] result = new double[tab.length];
        for(int i = 0; i<tab.length;i++){
            if(tab[i] > 0){
                result[i] = 1;
    ...
    static int najdluzszyCiagUjemnychh(int[] tab){
        int result = 0;
        int counter = 0;
    ...
    static int[] odwrocTablice2(int[] tab, int indeksStart, int indeksStop){
        int[] result = new int[tab.length];
        ...
        for(int i = 0; i < tab.length; i++){
            if(i < indeksStart || i > indeksStop){
                ...
                result[i] = tab[-i + indeksStart + indeksStop];
            }
        }
        return result;
    }
