...
public class zestaw2 {
    ...
    public static void main(String[] args){
        ...
        double[] genZ = geneujZakres(5, 10, 20);
...
//        System.out.println(funkcjaLiniowa(tab));
//        System.out.println(funkcjaKwadratowa(tab));
//        System.out.println(funkcjaWykladnicza(tab));
    ...
    static double[] geneujZakres(int n, double minWartosc, double maxWartosc){
